...
/**
 * JUnit4 Ui Tests for {@link SimpleCalculatorActivity} using the {@link AndroidJUnitRunner}.
...
@LargeTest
public class SimpleCalculatorActivityJUnit4StyleInstrumentedTest {
    /**
     ...
     */
    @Rule
    public ActivityTestRule<SimpleCalculatorActivity> mActivityRule = new ActivityTestRule<>(
    ...
    public void divZeroForOperandTwoShowsError() {
        // To get a reference to the activity you can use the {@link ActivityTestRule#getActivity()} method. 
